...
public class FunctionTest {
  ...
  public void test() throws Exception {
    GethomepagehtmltextFunction function = new GethomepagehtmltextFunction();
    FunctionOutput functionOutput = function.apply(createEventMock(), createContextMock());

    assertThat(
        functionOutput.getHtmltemplates(),
        hasItems(
            pojo(Htmltemplate.class)
                .withProperty("name", equalTo("5003000000D8cuIQAA"))
                .withProperty("htmltemplate", equalTo("Account One, inc.")),
            pojo(Htmltemplate.class)
                .withProperty("name", equalTo("6003000000D8cuIQAA"))
                .withProperty("htmltemplate", equalTo("Account Two, inc."))));
  }
